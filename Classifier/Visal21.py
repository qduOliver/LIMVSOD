...
for a in range(0, len(dataset_list)):
    ...
    path0 = r'F:\source\Visal17\9julei0_1_ed_train/%s/' % dataset
    path1 = r'F:\source\Visal17/18Sec_edTrain/%s/' % dataset
    save_path = r'F:\source\Visal17\21Second_train/%s/' % dataset
